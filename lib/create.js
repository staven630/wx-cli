...
module.exports = args => {
  ...
  shell.exec(
    `cd ${projectName} && npm init -y && npm install -S node-sass --registry=https://registry.npm.taobao.org --disturl=https://npm.taobao.org/dist --sass-binary-site=http://npm.taobao.org/mirrors/node-sass && npm i -S gulp gulp-sass  del cross-env gulp-preprocess gulp-rename gulp-postcss postcss-font-base64`,
    () => {
